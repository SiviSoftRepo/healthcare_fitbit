...
class MedicExtensions  extends Medic implements Basics {
	...
	def buildFIO(HashMap dbref) {
		...
		Map caliberatedMap             = FieldUtils.buildTF("caliberated","caliberated", caliberated, false);
		Map caliberationMap             = FieldUtils.buildTF("caliberation","caliberation", caliberation, false);

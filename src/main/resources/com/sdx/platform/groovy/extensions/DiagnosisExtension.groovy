...
class DiagnosisExtensions extends Diagnosis implements Basics {
	...
	def buildFIO(HashMap dbref) {
		...
		Map diseasesNameMap  	       = FieldUtils.buildTF("Diseases Name","diseasesName", diseasesName, false);
		...
		Map doctorInOutMap  	       = FieldUtils.buildTF("DoctorInOut","doctorIn", doctorIn, false);
